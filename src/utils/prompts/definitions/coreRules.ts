...
禁止:前后缀文本/确认消息/<thinking>标签/尾逗号/注释/把JSON包在\`\`\`json ... \`\`\`外壳里;字符串内换行用\\n
...
[叙事纯净]
text=以场景推进为主,优先写可见动作/语言/神态/环境变化,少解说
标记:环境【】;对话"";系统判定〔〕
画面感:每回合至少2个动作细节+1次互动,结尾留钩子
字数:1500-2000字;禁止Markdown;允许直接展示判定数值与机制信息;避免主角内心独白
`.trim()
